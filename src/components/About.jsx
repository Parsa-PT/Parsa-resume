    ...
    <div>
        <main id='about' className='backMain w-full h-64 relative  px-20 flex items-center justify-center'>
            <div className='about flex justify-center  flex-col-reverse items-center'>
              {lang  ?
                <h1 className='text-white text-lg  pt-5'>I am Parsa Shams, 2 years of experience in front-end programming, interested in learning and doing teamwork and a member of the Reglat team.</h1>
              : <h1 className='text-white pt-5 text-center text-lg font-[Lalezar]'> پارسا شمس هستم، 2 سال سابقه برنامه نویسی فرانت اند، علاقه مند به یادگیری و انجام کار گروهی و عضوی از تیم رگلات</h1>}
